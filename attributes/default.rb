default['chrome']['msi_64'] = 'https://dl-ssl.google.com/tag/s/appguid={00000000-0000-0000-0000-000000000000}'\
  '&iid={00000000-0000-0000-0000-000000000000}&lang=en&browser=4&usagestats=0&appname=Google%20Chrome&needsadmin=false'\
...
default['chrome']['msi'] = 'https://dl-ssl.google.com/tag/s/appguid={8A69D345-D564-463C-AFF1-A69D9E530F96}'\
  '&iid={806F36C0-CB54-4A84-A3F3-0CF8A86575E0}&lang=en&browser=3&usagestats=0&appname=Google%20Chrome&needsadmin=false'\
